...
class FLAME(nn.Module):
    ...
    def __init__(
        ...
        l_eyelid_path="models/l_eyelid.npy",
        r_eyelid_path="models/r_eyelid.npy",
        ...
        self.register_buffer(
            "l_eyelid", torch.from_numpy(np.load(l_eyelid_path)).to(self.dtype)[None]
        )
        self.register_buffer(
            "r_eyelid", torch.from_numpy(np.load(r_eyelid_path)).to(self.dtype)[None]
        )
        ...
        lmk_embeddings_mp = np.load(mediapipe_landmark_embedding)
        self.register_buffer(
            "mp_lmk_faces_idx",
