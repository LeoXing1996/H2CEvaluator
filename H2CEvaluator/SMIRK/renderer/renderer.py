...
class Renderer(nn.Module):
    def __init__(
        self,
        render_full_head=False,
        obj_filename="assets/head_template.obj",
        flame_mask="assets/FLAME_masks/FLAME_masks.pkl",
    ):
        ...
        flame_masks = pickle.load(open(flame_mask, "rb"), encoding="latin1")
